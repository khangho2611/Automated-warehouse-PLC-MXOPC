# Automated Warehouse PLC Control Simulation

PLC control simulation for the built-in Warehouse scene in Factory I/O using GX Works3 and MX OPC communication.
...
Watch demo video: https://youtu.be/8thByQM86zI
